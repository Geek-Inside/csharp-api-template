...
namespace CSharpAPITemplate.Infrastructure.JsonPatch
{
    /// <summary>
    ...
    public class JsonPatchDocumentDiffObserver<T> where T : class
    {
        ...
        public JsonPatchDocumentDiffObserver(T watchedInstance)
        {
            ...
            {
                _originalClone = default;
            }
            else
            {
                _originalClone = JsonConvert.DeserializeObject<T>(
                    JsonConvert.SerializeObject(_watchedInstance), 
        ...
        {
            return _generator.Generate(_originalClone, _watchedInstance);
        }
        ...
        {
            return _generator.Generate(_originalClone, _watchedInstance, jsonSerializer);
        }
    }
}